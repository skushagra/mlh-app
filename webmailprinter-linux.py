        ...
        if service_running == "True":
            ...
            for message in mail_box_messages:
                ...
                if print_mail_content == "True":
                    ...
                    print_command = 'lp "{}"'.format(content_path)
                ...
                if print_attachments == "True":
                    for att in message.attachments:
                        ...
                        print_command = 'lp "{}"'.format(mail_file_path)
                        print_queue.append(print_command)
...
class emailer():
    ...
    def send_in_queue(to_mail, total_attachments, ct):
        ...
        notification_html = list(connection.execute('SELECT variable_value FROM user_generated_frontend_preview WHERE uid=2'))[0][0]
